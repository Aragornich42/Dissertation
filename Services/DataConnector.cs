...
namespace Services
{
    internal class DataConnector
    {
        ...
        internal void AddEmployee(Employee employee)
        {
            ...
            {
                var profId = con.Query<int>("SELECT \"Id\" FROM \"Profession\" p WHERE p.\"Name\" = @Name", new { prof.Name });
            ...
            {
                var countryId = con.Query<int>("SELECT \"Id\" FROM \"Country\" c WHERE c.\"Name\" = @name", new { @name = forPas.CountryName });
            ...
            {
                var langId = con.Query<int>("SELECT \"Id\" FROM \"Language\" l WHERE l.\"Name\" = @name", new { @name = lang.LanguageName });
                var compId = con.Query<int>("SELECT \"Id\" FROM \"LanguageCompetence\" lc WHERE lc.\"Name\" = @name", new { @name = lang.LanguageCompetence });
