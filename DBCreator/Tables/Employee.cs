    ...
    public class Employee : Migration
    {
        public override void Up()
        {
            Create.Table("Employee").InSchema("public")
                .WithColumn("Id").AsInt64().PrimaryKey().NotNullable().Unique().Indexed().WithColumnDescription("Табельный номер")
                ...
                .WithColumn("Name").AsFixedLengthString(32).NotNullable().WithColumnDescription("Имя")
                ...
                .WithColumn("Birthplace").AsFixedLengthString(1024).NotNullable().WithColumnDescription("Место рождения")
                .WithColumn("Nationality").AsFixedLengthString(32).NotNullable().WithColumnDescription("Гражданство")
